...
class Logger {
  ...
  private formatMessage(
    ...
    const prefix = component ? `[${component}]` : "[NestFTs]"
  ...
  createComponentLogger(componentName: string) {
    return {
      debug: (message: string, data?: any) =>
        this.debug(message, data, componentName),
      info: (message: string, data?: any) =>
        this.info(message, data, componentName),
      warn: (message: string, data?: any) =>
        this.warn(message, data, componentName),
      error: (message: string, data?: any) =>
        this.error(message, data, componentName)
    }
  }
}
